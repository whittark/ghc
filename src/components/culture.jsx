          ...
          <section>
            <div className="row site-section" id="culture-section">
              <div className="col-12 text-center" data-aos="fade">
                <h2 className="section-title" style={{fontSize: '40px'}}>Culture</h2>
              </div>
            </div>
            <div className="container">
              ...
              <div className="row site-section " id="culture-section">
                ...
                <div className="col-12 text-center" data-aos="fade-up" data-aos-delay>
                  <img src="images/culture133.png" alt="Image" className="img-fluid" />
                </div>
                <div className="col-lg-2 text-left" data-aos="fade">
                </div>
                <div className="col-sm-8 text-left" data-aos="fade">
                  <h3>Underrepresentation in STEM workplaces</h3>
                  ...
                  <h3>Amplifying underrepresented groups</h3>
                  <p>Dr. Wade encourages us to listen and learn about these individuals to push them forward –either as a woman, a person of color, or an ally. We can all affect change for the next generation and lift others as we climb. </p>
                  <p>Dr. Wade also issued a warning and encouragement. As an advocate or ally, we’ll likely receive pushback. She reminds us “Don’t read the comments. Keep going.”</p>
                </div>
              </div>
              <div className="site-section bg-light" id="culture-section">
                <div className="container">
                  ...
                  <div className="row site-section" id="culture-section">
                    ...
                    <div className="col-12 text-center" data-aos="fade-up" data-aos-delay>
                      <img src="images/talent_pipelines33.png" alt="Image" className="img-fluid" />
                    </div>
                    <div className="col-sm-2 text-left" data-aos="fade">
                    </div>
                    <div className="col-sm-8 text-left" data-aos="fade">
                      <h3>Safeguarding our diversity</h3>
                      <p>The presenters shared that although it’s been proven that diversified cultures outperform, women of color are three times more likely to be regarded as someone of a lower employment level, are two times more likely to have others take credit for their work, and are 1.5 times more likely to leave an organization in response to microaggressions. </p>
                      <h3>Employment resource groups offer a solution</h3>
                      <p>Developing employment resource groups provide a way address these issues.</p>
                      <p>Four keys to ERG development:</p>
                      <ul>
                        <li>Top-down organizational support</li>
                        <li>ERG foundation building</li>
                        <li>Leveraging leaders and influencers</li>
                        <li>Deploying talent ambassadors</li>
                      </ul>
                      <p>The panel reminded attendees that it is “a marathon” to set up this structure for both grassroots and top-down leadership development. Be patient as you grow in these areas.</p>
                      <h3>Top-down organizational support</h3>
                      <p>Leveraging organizational support begins with organization-wide awareness from the top. The responsibility isn’t only on the employees. This can be in the form of policies and research groups sponsored by executive leadership. </p>
                      <p>The most effective practice is to integrate the business goals with employee resource goals. This ensures overall company awareness, as it’s a part of the operating rhythm. </p>
                      <h3>ERG foundation building</h3>
                      <p>The presenters expressed that program development is like building a house. You can’t build a house without building a solid foundation. Develop a roadmap for building an inclusive culture. This should also include a method for showing improvement and the benefits of implementation.</p>
                      <h3>Leveraging leaders and influencers</h3>
