            ...
            <div className="container">
              ...
              <div className="row site-section" id="feature-section">
                ...
                <div className="col-sm-8 text-left" data-aos="fade">
                  ...
                  <ul>
                    <li><b style={{color: 'rgb(88, 44, 131)'}}>Narrow AI:</b> This is what we experience today. Narrow AI is centered on performing specific tasks, such as predicting successful advertising based on user input or determining the flow of freeway traffic based on cell phone locations.</li>
                    <li><b style={{color: 'rgb(88, 44, 131)'}}>Broad AI – Disruptive and pervasive:</b> These are collections of AI tasks that share data stores across domains. An example might be population health AI accessing larger data sets used by census AI to predictively map infection rates in areas during a pandemic.</li>
                ...
                <div className="container">
                  ...
                  <div className="row site-section" id="ai-section">
                    ...
                    <div className="col-sm-8 text-left" data-aos="fade">
                      ...
                      <p>Microsoft’s AI bot Tay was quickly removed after being introduced because it began recycling racist and sexist comments that had collected unvetted in the AI’s data store. Other AI assistants, like Alexa and Siri, are perceived as female (have female names and voices). They are also servants. This serves to further ingrain damaging stereotypes about women, assuming that women belong in servile roles within our culture.</p>
                      ...
                      <h3>Example</h3>
                      <p>An algorithm in an e-book app detects that a user is a woman based on indicators within the  user’s profile. Even before the user begins to search, the algorithm returns titles it assumes that the user will prefer based on non-curated data stores and hides scientific or technical titles. Enough of these messages accumulated over time reinforce the idea that the user—a woman—has no place in  STEM.</p>
                    </div>
                  </div>
                  <div className="site-section bg-light" id="ai-section">
                    <div className="container">
                      ...
                      <div className="row site-section" id="ai-section">
                        ...
                        <div className="col-sm-8 text-left" data-aos="fade">
                          <h3>About Mica</h3>
                          <p>Mica is a realistic digital human developed by Magic Leap. The creative director and a behavioral scientist at Magic Leap share their journey in developing a virtual human that doesn’t propagate damaging stereotypes about women.</p>
                          <p style={{color: 'rgb(88, 44, 131)'}}>WT Note: In the presentations, slides depicted test users donning virtual reality headsets to see Mica. When worn, Mica would appear in the room seated accross from them.</p>
                          ...
                          <p>When Alice first met Mica, she was able to interact as she pleased. This caused Alice to walk away with concerns that this would continue stereotypes of women as passive and objectified. 
                            ...
                            <li><b style={{color: 'rgb(88, 44, 131)'}}>Why were people so insistent that Mica be an assistant?</b> For generations, women have been in servile, supportive positions. Alice was not interested in bringing the past forward in virtual human development and asks that we rewrite the script for the future.</li>
