            ...
            <div className="container">
              ...
              <div className="row site-section" id="feature-section">
                ...
                <div className="col-sm-8 text-left" data-aos="fade">
                  ...
                  <p>When a fax is received, clinical staff must manually process these documents and file them within a patient's chart. This job consumes the lion's share of their time, when their focus should be on patient care.</p>
                  ...
                  <p>Our organization processes more than 150 million faxes per year with a volume that is increasing exponentially. In 2017, athenahealth was spending approximately 2.3 million hours of employee time annually with the fax volume estimated to grow by 40%. If unchanged, the projected cost for this is 3.3 million hours in 2022.</p>
                  <p>This was not a sustainable model from an operational cost perspective. In addition, the costs to train employees was an additional challenge.</p>
