            ...
            <div className="container">
              ...
              <div className="row site-section" id="feature-section">
                ...
                <div className="col-sm-8 text-left" data-aos="fade">
                  ...
                  <ul>
                    <li><b style={{color: 'rgb(88, 44, 131)'}}>Automate categorization:</b> Start with a relatively easy problem to find a class from 39 possible options. <b style={{color: 'rgb(88, 44, 131)'}}>Result:</b> Machine learning can deliver at scale, which is 0.5M documents per day. <p style={{color: 'rgb(88, 44, 131)'}}>With automation, we reduced the processing time to <b>2.8M</b> hours from 2.9M.</p></li>
                    <li><b style={{color: 'rgb(88, 44, 131)'}}>Automate information extraction:</b> Reduce the time taken to capture data by prefilling it for users. <b style={{color: 'rgb(88, 44, 131)'}}>Result:</b> High accuracy in the data captured, resulting in faster processing with fewer errors. <p style={{color: 'rgb(88, 44, 131)'}}>This reduced processing hours to <b>2.36M</b> hours from 2.8M with a savings of 16% in processing time.</p></li>
                    <li><b style={{color: 'rgb(88, 44, 131)'}}>Hide high-confidence information:</b> Hide high confidence automated predictions so that the focus is only on what cannot be automated. <b style={{color: 'rgb(88, 44, 131)'}}>Result:</b> Further reduction of time in the data capture and QA processing as users only focus what was not automated.  <p style={{color: 'rgb(88, 44, 131)'}}>This reduced processing time by 11%, bringing it down to <b>2.1M</b> hours from 2.36M.</p></li>
                    <li><b style={{color: 'rgb(88, 44, 131)'}}>Skip manual QA processing:</b> If all fields are captured with high confidence by machine learning, we can skip entire manual QA process and make the processing truly “touchless.” <b style={{color: 'rgb(88, 44, 131)'}}>Result:</b> We can get high quality automation with higher accuracy even if no human QA is done. <p style={{color: 'rgb(88, 44, 131)'}}>This saves an additional 23% in processing time with the time reduced to <b>1.6M</b> hours from 2.1M.</p></li>
                  </ul>
                  <h3>Conclusion</h3>
