        ...
        <div className="container">
          ...
          <div className="row site-section " id="reactjs-section">
            ...
            <div className="col-sm-8 text-left" data-aos="fade">     
              ...
              <p style={{color: 'rgb(88, 44, 131)'}}>WT Note: I was not a presenter at GHC, but was so inspired by the presentations 
              ...
              <p><b style={{color: 'rgb(88, 44, 131)'}}>npm install create-react-app</b></p>
              ...
              <p><b style={{color: 'rgb(88, 44, 131)'}}>npm install</b></p>
              <p>Launch locally:</p>
              <p><b style={{color: 'rgb(88, 44, 131)'}}>npm start</b></p>
              ...
              <p style="text-align: center;"><img src="images/jsx-components.png" alt="Image" className="img-fluid" /></p>
              ...
              <p style="text-align: center;"><img src="images/react-class.png" alt="Image" className="img-fluid" /></p>
              ...
              <p style="text-align: center;"><img src="images/app-js.png" alt="Image" className="img-fluid" /></p>
              ...
              <p style="text-align: center;"><img src="images/root.png" alt="Image" className="img-fluid" /></p>
              ...
              <p style="text-align: center;"><img src="images/package-json.png" alt="Image" className="img-fluid" /></p>
              ...
              <p><b style={{color: 'rgb(88, 44, 131)'}}>git init</b></p>
              <p><b style={{color: 'rgb(88, 44, 131)'}}>git clone (your cloned repository address)</b></p>
              ...
              <p><b style={{color: 'rgb(88, 44, 131)'}}>npm install gh-pages</b></p>
              <p>This bundles your code upon deployment into a GitHub Page resource.</p>
              <p>Now push the project to GitHub:</p>
              <p><b style={{color: 'rgb(88, 44, 131)'}}>git add -A</b></p>
              <p><b style={{color: 'rgb(88, 44, 131)'}}>git commit -am “Your commit note”</b></p>
              <p><b style={{color: 'rgb(88, 44, 131)'}}>git push origin master</b></p>
              <p>In your Git repository, navigate to Settings &gt; GitHub Pages. Ensure that this is enabled. Check the GitHub page link to view your success. You are victorious!</p>
              <p style="text-align: center;"><img src="images/gh-pages.png" alt="Image" className="img-fluid" /></p>
              <h3>Resources</h3>
                <ul>
